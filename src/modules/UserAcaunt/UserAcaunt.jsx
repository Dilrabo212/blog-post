...
export default function UserAcaunt() {
    ...
    useEffect(() => {
        request.get(`/posts?userId=${pathname}`)
            .then(res => {
                setPosts(res)
            })
    }, [])
            ...
            <div className={cls.wrapper}>
                ...
                <div className={cls.midleContainer}>
                    <div className={cls.postWrp}>
                        <img className={cls.image} src={posts[0]?.image} alt="postes material" />
                        ...
                        <div className={cls.wrapper}>
                            ...
                            </svg>{posts[0]?.views}</span>

                        </div>
                    </div>
                    <div className={cls.infoSection}>
                        <h2 className={cls.postName}>{posts[0]?.title}
                        </h2>
